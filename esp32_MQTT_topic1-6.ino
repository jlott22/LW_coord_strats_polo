...
void sendtoMQTT(String topic, String msg) {
  if (topic == "5") {
    mqttClient.publish(pubtargettopic.c_str(), msg, 0, false);
  }
  else if (topic == "1") {
    ...
    mqttClient.publish(pubsyncstatetopic.c_str(), msg, 0, false);
  }
}
